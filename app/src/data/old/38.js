...
var poi = new point_of_interest_1.PointOfInterest("38", "Main Reception Foyer", "The hallway – a passage through time…", -26.173000, 28.075287);
poi.addElement({
    ...
    <blockquote>
        ...
        <footer>
        Brother Gabriel Andreucci, Postulator General of the Marist Brothers of the Schools
        </footer>
    </blockquote>
    `,

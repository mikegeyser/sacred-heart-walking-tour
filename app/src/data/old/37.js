...
var poi = new point_of_interest_1.PointOfInterest("37", "Library / Media Centre", "This was formerly the boarders’ dining room.", -26.173200, 28.075600);
poi.addElement({
...
poi.addElement({
    ...
    <p>
    "Now is the time, not tomorrow."<br/>
    "Don't sit and wait for better days. They won't come. You must make them NOW!"<br/>
    "Mommy and Nanny didn't pack your calculator today."<br/>
    "Just because you are in maths, doesn't mean you only have to learn mathematics."<br/>
    "Now go home to-day (with your hands on your eyes) and THINK for five minutes."<br/>
    "I can conquer the problems that conquered you in the test".<br/>
    </p>
    `,

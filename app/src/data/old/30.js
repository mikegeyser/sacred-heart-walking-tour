...
var poi = new point_of_interest_1.PointOfInterest("30", "The Hall", "A concourse for the body and mind.", -26.173400, 28.075400);
poi.addElement({
...
poi.addElement({
    ...
    <figure>
        <img src="assets/images/points-of-interest/30.10.jpg" />
        <figcaption>
        Image: Rory Birkby Photography / Marist Archive
        </figcaption>
    </figure>
    `,

...
var poi = new point_of_interest_1.PointOfInterest("4", "The Boarders", "Boarding was offered until the mid 1970s.", -26.173300, 28.075400);
poi.addElement({
...
poi.addElement({
    ...
    <footer>
    Sacred Heart College Yearbook, 1989 (p.10)
    </footer>
    </blockquote>
    `,
...
poi.addElement({
    ...
    furtherText: `
    <p>
    As Nolan went onto explain, it was …
    <img src="assets/images/points-of-interest/03.49b.jpg" />

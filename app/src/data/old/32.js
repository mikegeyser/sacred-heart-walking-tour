...
var poi = new point_of_interest_1.PointOfInterest("32", "The Struggle(s)", "Selected stories about some Sacred Heart’s activists from 1976-2016.", -26.173500, 28.075400);
poi.addElement({
...
poi.addElement({
    type: point_of_interest_1.PointOfInterestElementType.Audio,

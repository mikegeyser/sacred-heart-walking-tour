...
var poi = new point_of_interest_1.PointOfInterest("7", "Pre-Primary School", "The Orchard, Yeoville and the Pre-School.", -26.173000, 28.075400);
poi.addElement({
...
poi.addElement({
    ...
    <figure>
        <img src="assets/images/points-of-interest/07.03b.jpg" />
        <figcaption>
            Image: Marian Green
        </figcaption>
    </figure>

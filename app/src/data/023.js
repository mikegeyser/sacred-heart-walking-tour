...
var poi = new point_of_interest_1.PointOfInterest("023", "The Memorial Chapel", "The ‘new’ College Chapel completed in 1956.", -26.1734, 28.075287);
poi.addElement({
    type: 1,
    ...
    furtherText: `
    <p>The Apostolic Delegate (a representative of the Pope in a country where there are no regular diplomatic relations with the Vatican), The Most Reverend Damiano, consecrated the new college chapel on 7th October 1956.</p>
<p>A Pontifical High Mass is one celebrated by a Bishop (Most Reverend as a title denotes an Archbishop as Damiano was at the time of the then Transvaal) with special ceremonies – in this case relating to the consecration of the chapel.</p>
<p>The old chapel was not officially consecrated (meaning to set apart for association with the sacred rather than with this-world things) as a place of worship, rather dedicated. The difference between blessing/dedication and consecration is to do with permanence and ownership. One can assume this was because Sacred Heart College was built with funds from a mortgage for building works so the old chapel technically didn’t belong (literally) to the Marists at the time of the school opening, only once the mortgage had been paid off years later.</p>
<p>However, the entire funds (£20,000 South African pounds, equivalent to about R750,000 today) for the building, decoration and furnishing of the 1956 chapel were raised by the Ladies Committee over a ten-year period through fairs, sales, dances ‘and other ingenious schemes’ (according to the 1956 Maristonian).</p>
...
<p>In this image the original parquet flooring is visible. Over time this was replaced with tiling because of water damage through a leaking ceiling. The ceiling was restored and is today exactly as it looked in 1956. Also visible is a stone altar rail used to demarcate the more holy area of the chapel (since removed). The crucifix above the altar and the same 36 mahogany pews in use today, these cost £100 and £1260 respectively at the time. The statues to the left and right of the chancel area, of Mary and Joseph, came from the old chapel.</p>
...
poi.addElement({
    ...
    furtherText: `
    <p>Borbereki, who died in 1992, was a world renowned artist commissioned specially to create the Champagnat sculpture. Made from marble it was purchased for £300 (approx. R10 500 today). Other works by Borbereki can be found at the Johannesburg Art Gallery and in Standard Bank’s corporate art collection.</p>
<p>The full name of the chapel is <strong>The War Memorial Chapel of the Assumption of Our Lady and Blessed Marcellin Champagnat</strong>. The building fund was started in the name of the “Marist Brothers’ War Memorial Chapel Appeal” and was intended, as it is today, to serve as a place of reverent remembrance for those (Brothers and alumni) who died in both the First and Second World Wars of the twentieth century. A plaque with the names of 49 Old Boys who gave their lives in the First World War (1914 – 1918) can be seen at the back of the College Hall. A plaque for the 78 Old Boys named (in the 1944 Maristonian) as killed in action during the Second World war was proposed but never constructed.</p>
<p>The Assumption of Our Lady, traditionally celebrated on 15th August, is a feast day commemorating the ascension of Mary to heaven. The chapel is also dedicated to the Blessed Marcellin Champagnat, being built only a year after his Beatification and hence the use of the title “Blessed” rather than “Saint”. The altar, made from sandstone imported from Germany, contains relics of Champagnat.</p>
...
poi.addElement({
    ...
    furtherText: `
    <p>There are twelve stained glass windows in the chapel. All but one were designed and made by Barry Thompson with most of the windows being added to the chapel between 2000 and 2004, a project overseen by the then Primary Principal Mrs Gorst Allman. In 1956 the windows of the chapel were made of plain glass exactly as the circular windows set high above in the chancel area are still today.</p>
<p>The windows were sponsored by donors for individual reasons. For example, the Pre-School raised the funds for the window dedicated to St Francis of Assisi and some of the windows were sponsored by families wishing to mark the First Holy Communions of their children. Other windows were installed in remembrance of school staff members such as the ‘Safe in the arms of Jesus’ window dedicated to much loved primary teacher Penny Frangiskakis who died from cancer in 2002.</p>
...
poi.addElement({
    ...
    furtherText: `
    <p><em>Forever Young</em> by Bob Dylan, covered by a very talented grade 9 vocalist in 2016. The acoustics in the chapel are excellent.</p>

    `,
    url: "https://www.youtube.com/embed/Y64HYUToe4Y",
    reference: "Image: Sacred Heart College Archive"
});
exports.twentythree = poi;

...
poi.addElement({
    ...
    furtherText: `
    <p>The first uniform, a plain blue blazer with a blue and gold edging was worn at Observatory until the early 1930s.  The striped blazer came in after a 1933 resolution by the Provincial council of South African Marists:</p>
<blockquote>
...
<p>The Marist Centenary Digest magazine (1967) explains the blue and gold combination:</p>
<blockquote>
...
<p>This blazer crest, with M.B.J, is still used on ‘ordinary’ blazers (as opposed to Honors blazers) at St David’s College, Inanda and at Marian College, Linmeyer. Blazer badges, in the past, were not necessarily the same as that of the school badges or crests. Though today the College crest is that which appears on the blazer badge. </p>
...
poi.addElement({
    ...
    furtherText: `
    <p>This badge shown was used on Honours blazers only (with varying blues and widths of stripes used until the 1980s) and was used only up until the 1960s. After that it was used as a blazer badge for ‘ordinary’ school blazers in the 1970s. Honours blazers today are not striped but plain blue with gold edging – rather like the first school blazers.</p>
<p>The school badge has three gold stampers in the top right segment, similar to the crest of the City of Johannesburg and an allusion to location of the College being in the mining town. The left-hand symbol is the lamp of learning and below is the AM monogram. The reason for the addition of the green and red was perhaps was a way to include the two other school house colours (not represented by the blue and gold already in the crest). The school motto ‘In Meliora Contende’ meaning ‘strive for better’ is embroidered at the bottom of the badge.</p>

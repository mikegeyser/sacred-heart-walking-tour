...
var poi = new point_of_interest_1.PointOfInterest("23", "The Memorial Chapel", "The ‘new’ College Chapel completed in 1956.", -26.173400, 28.075287);
poi.addElement({
    type: point_of_interest_1.PointOfInterestElementType.Image,
...
poi.addElement({
    ...
    <p>
    Visible in this picture is the organ, with over 300 pipes, in 1956. Unfortunately, despite several visits from specialists who tried to restore it the organ is no longer in working order. 
    A portrait of Champagnat similar to Ridolfi’s can be seen to the left of the organ. Four of the fourteen carved and painted stations of the cross can be seen in this picture, originally these hung in the old chapel. On Good Friday today, as every year since the establishment of the school, the Marist Brothers lead a walk through 14 stations of reflection and prayer through the grounds, culminating in the orchard.
    </p>
    `,
...
poi.addElement({
    type: point_of_interest_1.PointOfInterestElementType.Video,
    ...
    furtherText: `
    <p>
    <i>Forever Young</i> by Bob Dylan, covered by a very talented grade 9 vocalist in 2016. The acoustics in the chapel are excellent.  
    </p>
    `,

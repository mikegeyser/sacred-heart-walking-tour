...
var poi = new PointOfInterest("031", "The Marist Archive", "A room at the hub of the College’s collective memories.", -26.173795, 28.075465);
...
poi.addElement({
    ...
    furtherText: `
    <p>At Sacred Heart College the model of a free/fee-paying school running concurrently is seen through the provision of bursaries for some learners and through the Three2Six Education Project for refugee children; it is foundational to the Marist ethos.</p>
<figure><img src="assets/images/points-of-interest/01.87.jpg" alt="">
  <figcaption>Image: C Kamana</figcaption>
</figure>

<p>This page from the Accounts Ledger of St Joseph’s Academy lists purchases by the Brothers in 1872 as including library books, ink mats, 20lbs of chocolate, 2 pigs and ½ lb of snuff. </p>
...
poi.addElement({
    ...
    furtherText: `
    <p>A plaque to honour Martingalia’s discovery of the caves was erected by Wits University to mark the centenary anniversary of the caves’ detection in October 1996 and in recognition of this important contribution to scientific and historical research. </p>
...
poi.addElement({
    ...
    furtherText: `
    <p>Born Ian Anthony Whiteford, in 1936 (in Johannesburg), Brother Martin was a learner at St Joseph’s College in Rondebosch from 1945-1953 where his family moved after the end of the Second World War. Marist Archivist for over 20 years until shortly before his death in 2013, he meticulously ordered and assembled the Archival material kept in the room at Observatory. In the latter years of this work Brother Martin had begun to digitalize many of the photographs and documentation kept in the archive and, in addition, he amassed biographies for almost every Brother appointed to and in South Africa since 1867. </p>
<p>Brother Martin taught Religious Education, Geography, the Cadets and some sports at Sacred Heart College from the 1970s until the mid 1980s. He was also responsible for retreats and pastoral care for both learners and staff at each of the schools he was involved with for later he moved to St. Henry’s, Durban and then into the Archivist role.</p>

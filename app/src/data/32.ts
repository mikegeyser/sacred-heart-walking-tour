...
var poi = new PointOfInterest("32", "The Struggle(s)", "Selected stories about some Sacred Heart’s activists from 1976-2016.", -26.173500, 28.075400);
...
poi.addElement({
    type: PointOfInterestElementType.Audio,

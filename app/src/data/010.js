...
var poi = new point_of_interest_1.PointOfInterest("010", "Grotto", "The statue of Madonna and Child .", -26.1736, 28.075287);
poi.addElement({
    type: 1,
    text: "A mosaicked pathway leads up to the statue of Madonna and Child.",
    furtherText: `
    <p>The Madonna and Child statue was enshrined in a specially prepared corner of the Orchard in 2008 by the Primary School. Known as The Grotto, provides a restful and contemplative area in which to escape the busy play area that the Orchard becomes during aftercare hours.</p>

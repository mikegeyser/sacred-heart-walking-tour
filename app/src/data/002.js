...
var poi = new point_of_interest_1.PointOfInterest("002", "Koch Street", "The first Sacred Heart College in Johannesburg.", -26.173581, 28.075099);
poi.themes = Marist;
Brothers;
' History,Koch Street,Alumni;;
poi.addElement({
    type: 1,

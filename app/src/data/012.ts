...
poi.addElement({
    ...
    furtherText: `
    <p>Brother Paul became a Marist Brother just a few years after finishing school in Johannesburg in 1924 (at Athlone Boys’ High School). Brother Paul trained in Italy and on returning to South Africa in 1926 and taught at many of the Marist Schools, including Koch Street and Observatory. He was elected to represent the South African Brothers at the General House in Italy in 1946 where he spent the next ten years. In 1957, having suffered degenerative eyesight during his time in Italy, he had an operation in London. The operation was not successful and Brother Paul was thereafter totally blind. </p>
...
<p>Brother Jude was Secretary General of the South African Catholic Bishops’ Conference in the late 1980s and the driving force in talks with the then Government around the desegregation of schools as Director of the Catholic Institute of Education (which he founded in 1985). Over the years he has contributed to positives change in the country, not least during the 80s and 90s in missions relating to social justice and in terms of the development of national and Catholic education policies. Recently Brother Jude set up the Marist Schools Council which concentrates on the development of Marist education in South Africa and continues to focus his spiritual calling at a grass roots level in this way.</p>

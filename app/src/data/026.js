...
var poi = new point_of_interest_1.PointOfInterest("026", "Uniform", "School uniform and badges over the last 128 years.", -26.1733, 28.075287);
poi.addElement({
    type: 1,
    ...
    furtherText: `
    <p>The Brothers however always wore ‘uniform’ when performing their duties at school. Their black soutanes (robes) with white starched split rectangular collars earnt them the nickname of “crows” amongst the boys both at Koch Street and in Observatory.</p>
...
poi.addElement({
    ...
    furtherText: `
    <p>The first uniform was a plain blue blazer with a blue and gold edging and was worn at Observatory until the early 1930s. The striped blazer came in after a 1933 resolution by the Provincial council of South African Marists decreed the following:</p>
<blockquote>
...
<p>The Marist Centenary Digest magazine (1967) surmises this about the blue and gold combination:</p>
<blockquote>
...
poi.addElement({
    ...
    furtherText: `
    <p>The blazer badge shown in this image is that of the school badge that was created especially for the College. Blazer badges, in the past, were not necessarily the same as that of the school badges or crests. Though today this is not the case as the college crest is that which appears on the blazer badge.</p>
<p>The badge shown here was used on Honours blazers only (like the one shown here with varying blues and widths of stripes used until the 1980s) and was used only up until the 1960s and after that as a blazer badge for ‘ordinary’ school blazers in the 1970s and early 1980s. Honours blazers today are not striped but plain blue with gold edging – rather like the first school blazers.</p>
<p>The school badge has a panel showing three gold stampers in the top right segment, similar to what appears on the crest of the City of Johannesburg and an allusion to location of the college being in the mining town. The left hand symbol is that of the lamp of learning and below is the AM monogram. The reason for the addition of the green and red is not clear but demonstrate the two other colours of the school houses (not represented by the blue and gold already in the crest). The school motto ‘In Meliora Contende’ meaning ‘strive for better’ is embroidered at the bottom of the badge.</p>
...
poi.addElement({
    ...
    furtherText: `
    <p>This badge was designed by Sister Mara O.S.U who was Deputy Principal of the Junior Primary school at the time and was a combination of symbols from the three schools that joined together in 1980. These three schools were Sacred Heart College Observatory, Holy Family Convent, Yeoville and St. Angela’s Convent, Bezuidenhout. For Sacred Heart College (or Marist Obs) the AM monongram is preserved in the badge. The Holy Family Convent, Yeoville (which continued to house the Sacred Heart nursery school until the 1990s) shamrock representing the Holy Family (Jesus, Mary and Joseph) is found in the bottom right. The seven stars in the Ursuline badge (for St Angela’s Convent was run by the Ursuline Order) are arranged in the constellation of Ursula Minor. In this badge the seven stars are rearranged and attached to the cross, the symbol of Christianity, which bound all three schools together. The cross was represented with a crook at the top. A crook is used by both Bishops and shepherds - for both of these figures is a tool that speaks to the care and management of a flock.</p>

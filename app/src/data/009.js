...
var poi = new point_of_interest_1.PointOfInterest("009", "The Orchard", "From private garden to community space", -26.173365, 28.074303);
poi.addElement({
    type: 1,
    ...
    furtherText: `
    <p>School grounds bordered by Norfolk pine trees planted by the Brothers at the outset of establishing the property, in consultation with the government’s forestry department. The orchard was planted with fruit trees; peach and fig. The avenues in the orchard area were planted with cedar trees.</p>
<p>Brother Henry, who along with Brother Florian (the first College Principal) was a keen botanist and they were both responsible for establishing the gardens and trees. Br Florian was known for his planning and landscaping, Br Henry for his tending to plants and shrubs. There was even a nursery for seedlings reported to have existed at the college in the early days.</p>
<p>The rectangular space at the top left of the orchard area was a vegetable patch from which fresh produce was procured for the dining room. Today a vegetable patch still exists in the Orchard but is now situated on the far western perimeter of the college grounds.</p>
...
poi.addElement({
    ...
    furtherText: `
    <p>In the archive there is no date associated with this picture however due to the lack of statue in the front niche (above the main steps) and the height of the trees it can be estimated at c 1930-1933.</p>
...
poi.addElement({
    ...
    furtherText: `
    <p>Cedar Avenue was the name given to the pathway around the perimeter of the orchard. Cedar Avenue exists today as the pathway that runs between the Pre Primary school and the open area in the orchard, down to the western perimeter of the College grounds. From the 1931 image (card 1) you can make out original the plume shape of the planting, however by the 1950s further planting on the south side of the orchard had extended the orchard into a heart shaped area. The ‘plume’ was thus the left hand side of the heart viewed from the west towards the east (the direction of the photograph in card 1).</p>
...
poi.addElement({
    ...
    furtherText: `
    <p>Today The Orchard is used by all sections of the school and for a wide range of reasons. Daily during term time, unless it’s raining, it is used as a grassy and shaded play area at break time. The Three2Six children congregate in the Orchard on arrival at school before they go off to class and a selection of extra-murals take place in its four corners. Primary aftercare is supervised here and after school, all ages (students, staff and parents) know it’s the place to find Sammy the ice-cream seller.</p>

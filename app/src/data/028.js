...
var poi = new point_of_interest_1.PointOfInterest("028", "Co-Education and Sacred Heart", "Marists, Holy Family Sisters and Ursuline Sisters combine in Sacred Heart College.", -26.1731, 28.0754);
poi.addElement({
    type: 1,
    ...
    furtherText: `
    <figure><img src="assets/images/points-of-interest/28.82b.jpg" alt="">

<figcaption>‘Oh brother! It’s girls, girls and more girls!’ Rand Daily Mail 12.01.1980</figcaption>

</figure>

<p>The story behind the amalgamation of the three school crests from Marist Brothers’ College, Observatory, Holy Family Convent, Yeoville and St. Angela’s Ursuline Convent, Kensington into one school blazer badge for Sacred Heart in 1980 can be read at POI 26 Uniform (slides 5, 6 and 7).</p>
...
<p>Brother Neil McGurk explained that the decision to become co-educational was not only a practical solution for the female pupils when the two Convent schools decided to close and one that saw the already intertwined educational heritages of the three congregations become physically linked but, rather hinged around something deeper:</p>
<blockquote>
...
poi.addElement({
    ...
    furtherText: `
    <p>The Holy Family of Bordeaux are a Catholic congregation formed by Pierre-Beinvenu de Noailles in 1820 when three young girls came to the newly ordained priest for spiritual direction and on consultation with his superior established a sisterhood inspired by imitation of the the Holy Family (Mary, Joseph and Jesus) and devotion to the three-in-one Christian concept of the God as a Trinity (Father, Son and Holy Spirit). The Sisterhood was to go onto have several branches each with a special focus, some on nursing, others on teaching and others in Christian mission.</p>
<p>Holy Family Sisters were invited to Johannesburg by Fr Monginoux O.M.I (who had also called the Marist Brothers to the city) and arrived in 1887. They set up a convent school at End Street (at the junction of Fox and Smal Streets) in Doornfontein. End Street was so named because at that time, in the 1880s, End Street formed the far eastern boundary of the city – the East End so to speak of Johannesburg, with Fordsburg being the furthest settlement to the West. The district of Doornfontein was entirely residential at the time.</p>
<p>Boys who had registered at the Holy Family Convent were some of the first pupils to move over to the newly established boys ‘school, Marist Brothers College at Koch Street in 1889. It is possible that some of the boys in this picture were amongst those first boys to attend Koch Street.</p>
<p>The Holy Family Sisters, from their beginnings in Johannesburg in the 1880s, flourished and set up several convent schools in the city. By the 1960s they had 100 sisters split between convents in Yeoville, Parktown, Coronationville, Kensington and Victory Park and a further 140 sisters in the rest of South Africa. The Holy Family Schools in Parktown and Coronationville still exist today.</p>
...
poi.addElement({
    ...
    furtherText: `
    <p>Another example of the communal activities between learners of the three schools that later merged can be seen here in the performance of Ursuline girls in the hall at Koch Street in 1950. Not only were the Catholic congregations coming together but this picture shows three yarmulke wearing boys, representative of the high proportion of Jewish pupils at both Sacred Heart Colleges in Koch Street and at Observatory. At least three of the pictured girls went on to join the sisterhood; Maureen Murray at the front right of the picture became Sister Veronica Murray who taught at the Ursuline School in Kensington and later became Headmistress of Brescia House from 1975-1980.</p>
...
<p>This statue of St Angela with a girl represents how the foundress of the Ursuline Sisters’ mission began when she gathered women to dedicate themselves to the teaching of girls, particularly impoverished girls, at a time when formal education for girls was unheard of.</p>
<p>This statue came from the St. Angela’s Ursuline Convent in Kensington to Sacred Heart in 1980 and was first installed, after being re-painted in white, on one of the traffic islands in front of the College (as can be seen in this picture). At the Ursuline Convent the statue was positioned in an alcove above an archway and this niche was, over time, colonized by honeybees. When the Chapel piazza was repaved in 1995, the statue of St Angela was moved to her current position between the Memorial Chapel and the main quad tunnel. It was at this time that the explanatory plaque under the statue was added.</p>

    `,
    url: "assets/images/points-of-interest/28.13.jpg",
    reference: "Image: Marist Archive"
});
exports.twentyeight = poi;

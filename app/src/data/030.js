...
poi.addElement({
    ...
    furtherText: `
    <p>There was no gym at the Koch Street school to begin but money was raised by the school and by local businessmen to build a gym for use by the boys and (after hours) residents of the area. Sir Lionel Philips, Randlord and husband of the foundress of the Johannesburg Art Gallery was one of the largest donors – giving 100 guineas. Frank Fillis, world renowned circus master, organised a special fund-raising matinee in contribution. </p>

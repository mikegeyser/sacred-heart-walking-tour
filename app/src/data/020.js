...
var poi = new PointOfInterest("020", "Music", "Musical traditions then and now.", -26.173777, 28.0754);
poi.addElement({
    type: 1,
...
poi.addElement({
    ...
    furtherText: "\n    <p>Teacher Garvin was one of the first music teachers employed at the school, along with Mr Hyde who was responsible for the Brass Band, together they some of the first lay members of staff - since staff were principally Brothers. Many of the boys learnt instruments as part of early extra \u2013mural activities. Singing, regarded as an important skill was a compulsory subject for all the boys. To accompany the Cadet Corps there was both a Reed Band (woodwind) and a Brass Band.</p>\n\n    ",
...
poi.addElement({
    ...
    furtherText: "\n    <p>The Marching Band at Sacred Heart College held a very special position within the school\u2019s history \u2013 from the Koch Street days and throughout many years at Observatory. Starting off as The Marching Band that led Cadet Corps displays, even after the Cadet\u2019s dissolution, the band \u2018marched on\u2019 leading learners to athletics meetings and swimming galas. It is because of this tradition that a \u2018march on\u2019 is still the format in which the school progresses to the top fields to take part in the annual inter-house athletics meeting in September but now music is played through the loudspeaker system rather than accompanied with an actual band.</p>\n\n    ",
...
poi.addElement({
    ...
    furtherText: "\n    <p>The Letebele Music Centre was opened in 2002 by Joseph Letebele and named for the family\u2019s long history with and worthy contributions to the school community. The centre, which was converted from staff accommodation at the turn of the millenium to a music block contained one large teaching classroom and twelve small rooms for musical tuition and practice. </p>\n<p>Today this space set aside for musical learning has become inadequate for the needs of the learners at Sacred Heart and so a new M.A.D Centre (Music, Arts and Drama Centre) is currently being fundraised for. Architectural plans have been drawn up and soon construction should begin for this new facility on the site of the existing kiosk in the sports fields. This should allow for the prodigious talents of the school learners in the arts to continue to grow and flourish further.</p>\n\n    ",

...
var poi = new point_of_interest_1.PointOfInterest("038", "Main Reception Foyer", "The hallway – a passage through time…", -26.173202, 28.075423);
poi.themes = Marist;
Brothers;
' History,Champagnat,Grounds and Buildings,Learning,Traditions and Innovations;;
poi.addElement({
    type: 1,
...
<p>Through the door and into the Foyer area another art display can be seen, this time from the Grade 6 ‘World Religions through Art’, an exhibition of cross-curricular work between Art and Religious Education classes, produced in 2016. </p>

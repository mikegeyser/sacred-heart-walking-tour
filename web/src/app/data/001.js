...
var poi = new point_of_interest_1.PointOfInterest("001", "Marist Brothers", "Beginnings in France, South Africa and now.", -26.173891, 28.075287);
poi.themes = Marist;
Brothers;
' History,Ethos,Champagnat;;
poi.addElement({
    type: 1,
